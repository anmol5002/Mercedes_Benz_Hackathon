...
class YOLO(object):
    ...
    def detect_image(self, image):
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            if predicted_class != 'person' and predicted_class != 'car' and predicted_class != 'bus' and predicted_class != 'truck' and predicted_class != 'bicycle' and predicted_class != 'motorbike':
               # print(predicted_class)
               continue
